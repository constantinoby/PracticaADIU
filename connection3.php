...
$sql="SELECT release_year, SUM(CASE WHEN type = 'Movie' THEN 1 ELSE 0 END) + SUM(CASE WHEN type = 'TV Show' THEN 1 ELSE 0 END) AS total_peliculas_y_series FROM netflix_titles GROUP BY release_year ORDER BY release_year DESC LIMIT 30";
